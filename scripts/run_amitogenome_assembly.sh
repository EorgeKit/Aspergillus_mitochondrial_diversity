...
#PBS -N assemble_potential_mitochondrial_genomes_rerun
#PBS -q normal
#PBS -P CBBI1470
...
MAPPED_FASTQ_BASE_DIR="/mnt/lustre/users/maloo/mbinda-George/analysis/mapped_reads_fastq"
...
find "${MAPPED_FASTQ_BASE_DIR}" -mindepth 1 -maxdepth 1 -type d | while read sample_fastq_dir; do
    ...
    r1_fastq="${sample_fastq_dir}/${sample_id}.mapped.R1.fastq.gz"
    r2_fastq="${sample_fastq_dir}/${sample_id}.mapped.R2.fastq.gz"
